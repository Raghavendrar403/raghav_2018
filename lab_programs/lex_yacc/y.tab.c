...
{
  "$end", "error", "$undefined", "KEYWORDS", "IDENTIFIERS", "OPERATORS",
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 19 "lab_6b.y" /* yacc.c:1646  */
    {printf("%s-->KEYWORD\n",yytext); key++; check();}
#line 1207 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 23 "lab_6b.y" /* yacc.c:1646  */
    {printf("%s-->OPERATOR\n",yytext); op++; check();}
#line 1213 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 26 "lab_6b.y" /* yacc.c:1646  */
